 ...
 */
public class NoteProvide extends ContentProvider {

    private static final String AUTHORITY = "com.yourcampusmap.rememberme.noteprovide";// "com.example.plainolnotes.notesprovider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        return database.query(DBOpenHelper.TABLE_NOTES, DBOpenHelper.ALL_COLUMNS,
                ...
                DBOpenHelper.NOTE_CREATED + "DESC"); // desc mean the data to be returned in descending
